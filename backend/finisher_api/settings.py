...
MIDDLEWARE = [
    ...
    'crm.geo_middleware.GeoAndVPNShieldMiddleware',
]
...
# Email Configuration (Resend / Transactional Domain Gateway)
EMAIL_BACKEND = config('EMAIL_BACKEND', default='django.core.mail.backends.smtp.EmailBackend')
EMAIL_HOST = config('EMAIL_HOST', default='smtp.gmail.com')
EMAIL_PORT = config('EMAIL_PORT', default=587, cast=int)
EMAIL_USE_SSL = config('EMAIL_USE_SSL', default=False, cast=bool)
EMAIL_USE_TLS = config('EMAIL_USE_TLS', default=not config('EMAIL_USE_SSL', default=False, cast=bool), cast=bool)
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='The Finisher Luxury Registrations <noreply@mtamboholdings.dev>')
SALES_EMAIL = config('SALES_EMAIL', default='noreply@mtamboholdings.dev').strip()

# Public website lead ownership settings
PUBLIC_LEAD_OWNER_EMAIL = config('PUBLIC_LEAD_OWNER_EMAIL', default='').strip()
PUBLIC_LEAD_OWNER_USERNAME = config('PUBLIC_LEAD_OWNER_USERNAME', default='').strip()
PUBLIC_LEAD_COMPANY_NAME = config('PUBLIC_LEAD_COMPANY_NAME', default='Mtambo Holdings').strip()
...
# ==============================================================================
# INSTITUTIONAL SECURITY & POPIA SECTION 19 HARDENING (R25M ASSET PROTECTION)
# ==============================================================================
