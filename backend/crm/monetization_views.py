...
class WhiteLabelCheckoutView(APIView):
    ...
    def post(self, request):
        ...
        return Response({
            ...
            'return_url': 'https://thefinishercrm.tech/settings?white_label=success',
            'cancel_url': 'https://thefinishercrm.tech/settings?white_label=cancel',
...
class TenderPackCheckoutView(APIView):
    ...
    def post(self, request):
        ...
        return Response({
            ...
            'name_last': user.last_name or 'Director',
            'email_address': user.email,
            'return_url': 'https://thefinishercrm.tech/reports?tender_pack=success',
            'cancel_url': 'https://thefinishercrm.tech/reports?tender_pack=cancel',
            'notify_url': 'https://the-finisher-luxury-api.onrender.com/api/billing/webhook/'
        })
