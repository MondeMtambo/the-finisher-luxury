...
class Company(models.Model):
    ...
    trading_name = models.CharField(max_length=200, blank=True, help_text="Trading As / T/A")
    registration_number = models.CharField(max_length=30, blank=True, help_text="CIPC Registration Number (e.g. 2024/123456/07)")
    tax_number = models.CharField(max_length=30, blank=True, help_text="SARS Tax / VAT Number")
    industry = models.CharField(max_length=100, blank=True, help_text="Industry / Sector")
    cipc_verified = models.BooleanField(default=False, help_text="Verified against CIPC format / database")
...
class SecurityAuditTrail(models.Model):
    ...
    EVENT_TYPES = [
        ...
        ('AUTH_REGISTRATION', 'Registration Attempt'),
        ('AUTH_APPROVAL', 'Login / Access Approval'),
