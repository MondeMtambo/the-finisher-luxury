      ...
      <div class="terms-modal" ref="modalShell" tabindex="-1">
        ...
        <div class="tm-body" @scroll="handleScroll" ref="scrollContainer">
          <div class="terms-content">
            ...
            <section><h3>4. Privacy and Data Protection</h3><p>We are committed to protecting your privacy. Your personal information and CRM data are stored securely and will never be shared with third parties without your explicit consent, except as required by law. We implement industry-standard security measures including:</p><ul><li>Encrypted data transmission (HTTPS/TLS);</li><li>Secure password hashing;</li><li>Regular security audits;</li><li>Access controls and authentication;</li><li>Data backup and recovery procedures.</li></ul></section>
            ...
            <section><h3>12. Contact Information</h3><p>If you have any questions about these Terms &amp; Conditions, please contact us at:<br><strong>Email:</strong> legal@thefinisher.com<br><strong>Address:</strong> THE FINISHER CRM Solutions<br><strong>Last Updated:</strong> {{ new Date().toLocaleDateString() }}</p></section>
...
.terms-modal { background:#fff;border-radius:var(--radius-lg);max-width:680px;width:100%;max-height:90vh;display:flex;flex-direction:column;box-shadow:var(--shadow-xl); }
.tm-header { display:flex;justify-content:space-between;align-items:center;padding:1.25rem 1.5rem;border-bottom:1px solid var(--border-color); }
.tm-header h2 { font-size:1.125rem;font-weight:700;color:var(--gray-900);margin:0; }
.modal-close { background:none;border:none;font-size:1.5rem;color:var(--gray-400);cursor:pointer;width:32px;height:32px;display:flex;align-items:center;justify-content:center;border-radius:var(--radius-sm); }
.modal-close:hover { background:var(--gray-100);color:var(--gray-700); }
.tm-body { flex:1;overflow-y:auto;padding:1.5rem; }
.terms-content section { margin-bottom:1.5rem; }
.terms-content h3 { font-size:.875rem; font-weight:600; color:var(--primary-500); margin:0 0 .5rem; }
.terms-content p { font-size:.8125rem; color:var(--gray-600); line-height:1.6; margin:0 0 .5rem; }
.terms-content ul { margin:.25rem 0 .5rem; padding-left:1.25rem; font-size:.8125rem; color:var(--gray-600); line-height:1.7; }
.terms-content li { margin:.25rem 0; }
.scroll-ind { position:sticky;bottom:0;background:var(--gray-50);border:1px solid var(--border-color);padding:.75rem;text-align:center;border-radius:var(--radius-md);margin-top:.75rem; }
.scroll-ind p { margin:0;font-size:.8125rem;font-weight:600;color:var(--primary-500);animation:pulse 2s ease-in-out infinite; }
@keyframes pulse { 0%,100%{opacity:1} 50%{opacity:.6} }
.tm-footer { padding:1rem 1.5rem;border-top:1px solid var(--border-color); }
