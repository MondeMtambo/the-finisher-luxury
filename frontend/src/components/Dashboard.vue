      ...
      >
        <div class="stat-card card" @click="onStatCardClick(element.key)" role="button" tabindex="0">
          ...
          <div class="stat-icon-wrap" :class="element.key">
            ...
            <svg v-else-if="element.key==='deals'" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>
